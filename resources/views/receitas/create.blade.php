                ...
                <div class="card-body">
                    <form method="POST" action="{{route('receitas.store')}}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" step=".01" class="form-control" id="valorReceita" name="valorReceita">
                        </div>
                        <div class="form-group">
                            <label for="descricaoReceita">Descrição</label>
                            <input type="text" class="form-control" id="descricaoReceita" name="descricaoReceita" aria-describedby="descricaoReceitalHelp">
                        ...
                        <div class="form-group form-check">
                            <input type="checkbox" class="form-check-input" id="recebido" name="recebido">
